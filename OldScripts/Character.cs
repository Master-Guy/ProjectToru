...
public class CharacterOld : Drawable
{
	...
	public RoomOld location;

	public CharacterBehaviour character;

	// TODO fix
	public CharacterOld(string sprite, RoomOld startLocation) : base(sprite)
	{
	...
	public void move(RoomOld destination)
	{
		List<RoomOld> route = new List<RoomOld>();
